...
const button =
  "rounded-[--radius-eture] bg-[--color-brand] px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[--color-brand-ink] disabled:opacity-40";
const panel = "rounded-[--radius-eture] border border-[--color-line] p-6";
...
export function AdminForms({ squads }: { squads: Squad[] }) {
  ...
  return (
    <div className="space-y-6">
      {message && (
        <p className="rounded-[--radius-eture] bg-[--color-surface] p-4 text-sm">{message}</p>
      )}
          ...
          {kind !== "training" && (
            <label className="flex items-start gap-3 sm:col-span-2">
              ...
              <span className="text-sm">
                ...
                <span className="mt-0.5 block text-[--color-muted]">
